...
If you are deciding whether that scope is worth owning, read [build versus buy](/blog/build-vs-buy-an-lms-the-honest-math). For a three-year model, see [custom LMS versus off-the-shelf](/blog/custom-lms-vs-off-the-shelf-total-cost-of-ownership-over-three-years). And for what actually shapes a first-release estimate, start with [how much a custom LMS costs in 2026](/blog/how-much-does-a-custom-lms-cost-in-2026).
