...
For sites going directly to 5.2 rather than stopping at 5.0, also read the [Moodle 5.2 upgrade guide](/blog/moodle-5-2-upgrade-guide). The 5.1 public directory change and router requirement layer on top of what 5.0 introduced.
