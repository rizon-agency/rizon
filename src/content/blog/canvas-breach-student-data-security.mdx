...
In many cases you're holding information about minors. You may have student ID numbers, which in some systems link to academic records or even government identifiers. You have private messages, contact details, and behavioral data about how people learn. This is precisely the kind of information that causes real harm when it leaks, and precisely the kind that regulators care about most. In the United States, [FERPA](https://studentprivacy.ed.gov/faq/what-ferpa) sets the rules for who may see a student's education records, and the penalties for getting it wrong are not theoretical.
