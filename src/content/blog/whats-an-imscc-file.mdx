...
If the reason you're looking this up is that you're moving off a platform you don't control, the cleanest version of this problem is landing somewhere you own outright. That's the throughline of [custom LMS development](/services/custom-lms-development) and of the [Canvas alternative you actually control](/alternatives/canvas): the cartridge gets your content out, and a platform you own decides what happens to it next.
