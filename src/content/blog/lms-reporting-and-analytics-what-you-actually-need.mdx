...
**Completion rate.** Completion matters for compliance and operations. It does not prove comprehension or impact. It can even reward a programme for making the final button easier to reach.
...
An LMS can store its own events in an internal model. Standards matter when learning happens across several tools or the organisation needs portable records.
