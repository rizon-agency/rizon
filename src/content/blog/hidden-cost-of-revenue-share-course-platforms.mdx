...
If you already run Moodle, there's a middle step before a full build: [connecting WooCommerce to Moodle with Edwiser Bridge](/blog/connect-woocommerce-to-moodle-with-edwiser-bridge) cuts out the revenue-share fee entirely, at the cost of taking on the checkout logic yourself.
