...
Not every SSO problem is enterprise-scale. Plugins like Edwiser Bridge ship a simpler version of the same idea, syncing one login between WordPress and Moodle, which is worth understanding on its own terms before you reach for SAML or OIDC: see [connecting WooCommerce to Moodle with Edwiser Bridge](/blog/connect-woocommerce-to-moodle-with-edwiser-bridge).
