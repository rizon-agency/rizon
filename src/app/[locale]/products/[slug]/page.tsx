...
const pageCopy = {
  ...
  researchEyebrow: { en: "Research focus", fr: "Axes de recherche", es: "Foco de investigación", de: "Forschungsschwerpunkt" },
  researchTitle: {
            ...
            <div className="lg:col-span-4">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <Button asChild variant="outline">
                  <a href="https://cal.com/rizon.agency-cvbkll/30min" target="_blank" rel="noopener noreferrer">
        ...
        <section className="container mt-24 md:mt-32">
          ...
          <div className="mt-12 grid grid-cols-1 gap-5 md:grid-cols-2">
            {product.researchFocus.map((item) => (
              <article key={l(item.title, typedLocale)} className="surface p-7 md:p-8">
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
            ...
            <div className="grid gap-5 lg:col-span-8">
              {product.publicSiteRole.map((item) => (
                <article key={l(item.title, typedLocale)} className="border-t border-border pt-6">
