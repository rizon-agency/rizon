...
export const metadata: Metadata = { title: "Custom Learning Platform Services | Rizon", description: "Custom LMS, corporate training, course platform, and school portal development for teams that need learning software built around their operation.", alternates: { canonical: `${BASE_URL}/services` }, openGraph: { title: "Custom Learning Platform Services | Rizon", description: "Four ways Rizon builds learning products around the work they need to do.", url: `${BASE_URL}/services`, siteName: "Rizon", locale: "en_US", type: "website" }, twitter: { card: "summary_large_image", title: "Custom Learning Platform Services | Rizon", description: "Four ways Rizon builds learning products around the work they need to do.", creator: "@rizon_agency" } };
