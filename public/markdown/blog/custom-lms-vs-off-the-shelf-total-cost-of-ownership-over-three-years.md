...
Here is a deliberately simple planning model for a programme business with 2,000 active learners, team sales, and one operations coordinator. These are not vendor quotes. They are placeholders to force the right categories into the conversation.

| Cost line | Hosted LMS, three years | Custom LMS, three years |
| --- | ---: | ---: |
| Licence or hosting | $36,000 | $9,000 |
| Initial implementation | $15,000 | $55,000 |
| Staff workarounds and reporting | $45,000 | $12,000 |
| Plugins, integration maintenance, or change work | $18,000 | $18,000 |
| Migration and launch support | $6,000 | $10,000 |
| **Illustrative total** | **$120,000** | **$104,000** |

The custom option begins with a much larger cheque. That is normal. It may also need more deliberate ownership after launch. The hosted option looks calm at first because the licence bundles infrastructure and product upkeep. But year two is often where the manual work becomes visible: the coordinator who prepares a client report at month-end, the plug-in upgrade that changes an enrolment rule, the new B2B offer that needs an awkward workaround.
...
The U.S. Bureau of Labor Statistics reports a **$133,080** median annual wage for software developers in May 2024. That context matters because ongoing product work is real work; a custom platform needs a budget for maintenance, security updates, and measured improvements. [Read the BLS source.](https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm)
...
For the first-release range, start with [how much a custom LMS costs](how-much-does-a-custom-lms-cost-in-2026.md). For the decision before the spreadsheet, read [build versus buy](build-vs-buy-an-lms-the-honest-math.md). And if the estimate itself feels mysterious, [what drives e-learning build cost](what-actually-drives-the-price-of-an-e-learning-build.md) breaks it down.
