...
If the plan is a custom platform rather than another Moodle, the two load-bearing plugins stop being risks and become part of the spec. The cohort-access rule and the competency calculation get written down, built on purpose, and tested. That's the real argument for [a custom Moodle alternative](/alternatives/moodle): not that Moodle is bad, but that the rules you've been keeping in plugins and memory finally get to live in code you own.

For the standards work underneath a move, read [SCORM vs xAPI](scorm-vs-xapi-keeping-your-content-portable.md). For the shape of the whole cutover, see [what a smooth LMS migration actually looks like](what-a-smooth-lms-migration-actually-looks-like.md). And if you're weighing whether to rebuild at all, [custom LMS development](/services/custom-lms-development) starts with exactly this kind of inventory.
